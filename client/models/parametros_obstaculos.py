Escala=1
PARAMS = {
    'piedra':  { 'repulsion': 50000*Escala,  'radio': 200 *Escala, "radio_geo":20.0 },# 
    'buque':   { 'repulsion': 300000*Escala,  'radio': 250*Escala, "radio_geo":90.0 },# 
    'boya':    { 'repulsion': 15500*Escala,  'radio': 100 *Escala, "radio_geo":10.0},# 
    'default': { 'repulsion': 150*Escala,  'radio': 150 *Escala, "radio_geo":30.0},
...
def clasificar_obstaculo(raw_tag: str) -> str:
    """
    Dada la etiqueta recibida en el CoT,
    ...
    if 'buoy' in tag or 'boya' in tag:
        return 'boya'
    if 'barco' in tag or 'ship' in tag or 'boat' in tag:
        return 'buque'
    return 'default'